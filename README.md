...
| [plugin-example](plugin)               | Show how newly added plugins are discovered and used transparently by the ng-xtend framework                                                                                  | Yes                  | Custom      | Static         | Yes         | No    |
| [inout-example](inout)                 | Show how unknown components can be connected together throught outputs and inputs                                                                                             | Yes                  | Custom      | Static         | Yes         | No    |
